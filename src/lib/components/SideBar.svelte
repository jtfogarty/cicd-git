...
<nav class="w-[70px] text-[#f3f5f8] bg-[#1a2a37] h-screen fixed top-[70px] left-0 lg:block" >
    <div class="gap-2">
    ...
    <a href="/Configure" class="flex py-2.5 hover:bg-[#1f2e3c] gap-2 items-center flex-col">
        <img src="/icons/gear.svg" class="h-6 w-6 " alt="">
        <span class="capitalize text-[12px]">Setup</span>
    </a>
    </div>
</nav>